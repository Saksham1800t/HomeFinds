...
function ProductInfo() {
  ...
  return (
    <div className='background_RentNow'>
...
<div className="seller_BuyNow d-flex">
  <img src={profile} className="image_RentNow" alt="profile" ></img>
  <div className="heading_BuyNow">
    <h3>Seller</h3>
    <h5>764583499</h5>
  </div>
  </div>
        <button className="button_RentNow"><b>BuyNow</b></button>
      </div>
